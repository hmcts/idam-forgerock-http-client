...
public interface RoleRoleMembersApi extends ApiClient.Api {
  ...
  RoleMembers deleteIfMatch(@Param("roleId") String roleId, @Param("id") String id, @Param("cookie") String cookie, @Param("ifMatch") String ifMatch, @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  RoleMembers get(@Param("roleId") String roleId, @Param("id") String id, @Param("cookie") String cookie, @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  RoleMembers patchIfMatch(@Param("roleId") String roleId, @Param("id") String id, uk.gov.hmcts.reform.idam.api.fr.shared.model.PatchArray requestPayload, @Param("fields") String fields, @Param("cookie") String cookie, @Param("ifMatch") String ifMatch);
  ...
  RoleMembers patchIfMatch(@Param("roleId") String roleId, @Param("id") String id, uk.gov.hmcts.reform.idam.api.fr.shared.model.PatchArray requestPayload, @Param("cookie") String cookie, @Param("ifMatch") String ifMatch, @QueryMap(encoded = true) Map<String, Object> queryParams);
   ...
   * @return RoleMembers
   */
  @RequestLine("POST /managed/role/{roleId}/members?_fields={fields}")
  @Headers({
    "Content-Type: application/json",
    "Accept: application/json",
    "Cookie: {cookie}"
  ...
  RoleMembers post(@Param("roleId") String roleId, RoleMembers requestPayload, @Param("cookie") String cookie, @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  RoleMembers putIfRevision(@Param("roleId") String roleId, @Param("id") String id, RoleMembers requestPayload, @Param("cookie") String cookie, @Param("ifNoneMatch") String ifNoneMatch, @Param("ifMatch") String ifMatch, @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  RoleMembersQueryResult queryFilter(@Param("roleId") String roleId, @Param("fields") String fields, @Param("cookie") String cookie, @Param("queryFilter") String queryFilter, @Param("queryId") String queryId, @Param("pageSize") Integer pageSize, @Param("totalPagedResultsPolicy") String totalPagedResultsPolicy, @Param("sortKeys") String sortKeys);
