...
public interface UserAuthorizationRolesApi extends ApiClient.Api {
  ...
  UserAuthzRoles deleteIfMatch(@Param("userId") String userId, @Param("id") String id, @Param("cookie") String cookie, @Param("ifMatch") String ifMatch, @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  UserAuthzRoles get(@Param("userId") String userId, @Param("id") String id, @Param("cookie") String cookie, @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  UserAuthzRoles patchIfMatch(@Param("userId") String userId, @Param("id") String id, uk.gov.hmcts.reform.idam.api.fr.shared.model.PatchArray requestPayload, @Param("fields") String fields, @Param("cookie") String cookie, @Param("ifMatch") String ifMatch);
  ...
  UserAuthzRoles patchIfMatch(@Param("userId") String userId, @Param("id") String id, uk.gov.hmcts.reform.idam.api.fr.shared.model.PatchArray requestPayload, @Param("cookie") String cookie, @Param("ifMatch") String ifMatch, @QueryMap(encoded = true) Map<String, Object> queryParams);
   ...
   * @return UserAuthzRoles
   */
  @RequestLine("POST /managed/user/{userId}/authzRoles?_fields={fields}")
  @Headers({
    "Content-Type: application/json",
    "Accept: application/json",
    "Cookie: {cookie}"
  ...
  UserAuthzRoles post(@Param("userId") String userId, UserAuthzRoles requestPayload, @Param("cookie") String cookie, @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  UserAuthzRoles putIfRevision(@Param("userId") String userId, @Param("id") String id, UserAuthzRoles requestPayload, @Param("cookie") String cookie, @Param("ifNoneMatch") String ifNoneMatch, @Param("ifMatch") String ifMatch, @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  UserAuthzRolesQueryResult queryFilter(@Param("userId") String userId, @Param("fields") String fields, @Param("cookie") String cookie, @Param("queryFilter") String queryFilter, @Param("queryId") String queryId, @Param("pageSize") Integer pageSize, @Param("totalPagedResultsPolicy") String totalPagedResultsPolicy, @Param("sortKeys") String sortKeys);
