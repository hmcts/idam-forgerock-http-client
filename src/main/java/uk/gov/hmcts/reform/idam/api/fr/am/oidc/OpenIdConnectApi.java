...
public interface OpenIdConnectApi extends ApiClient.Api {
    ...
    Map<String, Object> idTokenInfo(@Param("authorization") String authorization, @Param("id_token") String idToken, @QueryMap(encoded = true) Map<String, Object> queryParams);

    /**
     * A convenience class for generating query parameters for the
     * <code>idTokenInfo</code> method in a fluent style.
     */
    public static class IdTokenInfoParams extends HashMap<String, Object> {
        public IdTokenInfoParams realm(final String value) {
            put("realm", EncodingUtils.encode(value));
            return this;
        }

        public IdTokenInfoParams claims(final String value) {
    ...
    default String getAuthorizationCode(GetAuthorizationCodeParams params) {
        ...
        if (!(feignResponse.status() < 400 && feignResponse.status() >= 300)) {
