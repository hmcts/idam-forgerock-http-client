...
public class OAuth2ClientsResultSet {
  ...
  public OAuth2ClientsResultSet result(List<OAuth2Client> result) {
    this.result = result;
    return this;
  }

  public OAuth2ClientsResultSet addResultItem(OAuth2Client resultItem) {
    if (this.result == null) {
  ...
  **/
  ...
  public List<OAuth2Client> getResult() {
    return result;
  }

  public void setResult(List<OAuth2Client> result) {
    this.result = result;
  }

  public OAuth2ClientsResultSet resultCount(Integer resultCount) {
  ...
  **/
  ...
  public OAuth2ClientsResultSet pagedResultsCookie(String pagedResultsCookie) {
  ...
  **/
  ...
  public OAuth2ClientsResultSet totalPagedResultsPolicy(String totalPagedResultsPolicy) {
  ...
  **/
  ...
  public OAuth2ClientsResultSet totalPagedResults(Integer totalPagedResults) {
  ...
  **/
  ...
  public OAuth2ClientsResultSet remainingPagedResults(Integer remainingPagedResults) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OAuth2ClientsResultSet oauth2ClientsResultSet = (OAuth2ClientsResultSet) o;
    return Objects.equals(this.result, oauth2ClientsResultSet.result) &&
        Objects.equals(this.resultCount, oauth2ClientsResultSet.resultCount) &&
        Objects.equals(this.pagedResultsCookie, oauth2ClientsResultSet.pagedResultsCookie) &&
        Objects.equals(this.totalPagedResultsPolicy, oauth2ClientsResultSet.totalPagedResultsPolicy) &&
        Objects.equals(this.totalPagedResults, oauth2ClientsResultSet.totalPagedResults) &&
        Objects.equals(this.remainingPagedResults, oauth2ClientsResultSet.remainingPagedResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class OAuth2ClientsResultSet {\n");
