...
public interface UserProvisioningRolesApi extends ApiClient.Api {
   ...
   */
  @RequestLine("GET /managed/user/{userId}/roles?_fields={fields}&_queryFilter={queryFilter}&_pagedResultsCookie={pagedResultsCookie}&_pageSize={pageSize}&_totalPagedResultsPolicy={totalPagedResultsPolicy}&_sortKeys={sortKeys}")
  @Headers({
          "Accept: application/json",
          "Cookie: {cookie}"
  })
