...
public interface RoleAuthorizationRoleMembersApi extends ApiClient.Api {
  ...
  RoleAuthzMembers deleteIfMatch(@Param("roleId") String roleId, @Param("id") String id, @Param("cookie") String cookie, @Param("ifMatch") String ifMatch, @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  RoleAuthzMembers get(@Param("roleId") String roleId, @Param("id") String id, @Param("cookie") String cookie, @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  RoleAuthzMembers patchIfMatch(@Param("roleId") String roleId, @Param("id") String id, uk.gov.hmcts.reform.idam.api.fr.shared.model.PatchArray requestPayload, @Param("fields") String fields, @Param("cookie") String cookie, @Param("ifMatch") String ifMatch);
  ...
  RoleAuthzMembers patchIfMatch(@Param("roleId") String roleId, @Param("id") String id, uk.gov.hmcts.reform.idam.api.fr.shared.model.PatchArray requestPayload, @Param("cookie") String cookie, @Param("ifMatch") String ifMatch, @QueryMap(encoded = true) Map<String, Object> queryParams);
   ...
   * @return RoleAuthzMembers
   */
  @RequestLine("POST /managed/role/{roleId}/authzMembers?_fields={fields}")
  @Headers({
    "Content-Type: application/json",
    "Accept: application/json",
    "Cookie: {cookie}"
  ...
  RoleAuthzMembers post(@Param("roleId") String roleId, RoleAuthzMembers requestPayload, @Param("cookie") String cookie, @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  RoleAuthzMembers putIfRevision(@Param("roleId") String roleId, @Param("id") String id, RoleAuthzMembers requestPayload, @Param("cookie") String cookie, @Param("ifNoneMatch") String ifNoneMatch, @Param("ifMatch") String ifMatch, @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  RoleAuthzMembersQueryResult queryFilter(@Param("roleId") String roleId, @Param("fields") String fields, @Param("cookie") String cookie, @Param("queryFilter") String queryFilter, @Param("queryId") String queryId, @Param("pageSize") Integer pageSize, @Param("totalPagedResultsPolicy") String totalPagedResultsPolicy, @Param("sortKeys") String sortKeys);
