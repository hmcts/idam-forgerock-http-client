lazy val root = (project in file(".")).
  settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.github.openfeign" % "feign-core" % "13.8" % "compile",
      "io.github.openfeign" % "feign-jackson" % "13.8" % "compile",
      "io.github.openfeign" % "feign-slf4j" % "13.8" % "compile",
      ...
      "com.fasterxml.jackson.datatype" % "jackson-datatype-jsr310" % "2.21.0" % "compile",
