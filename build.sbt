lazy val root = (project in file(".")).
  settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.github.openfeign" % "feign-core" % "13.12" % "compile",
      "io.github.openfeign" % "feign-jackson" % "13.12" % "compile",
      "io.github.openfeign" % "feign-slf4j" % "13.12" % "compile",
      ...
      "com.fasterxml.jackson.datatype" % "jackson-datatype-jsr310" % "2.21.3" % "compile",
